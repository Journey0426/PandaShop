<template>
  <div class="detail">
    ...
    <section class="con">
      <!-- 导航路径区域 -->
      <div class="conPoin">
        <span v-show="categoryVew.category1Name">{{categoryVew.category1Name}}</span>
        <span v-show="categoryVew.category2Name">{{categoryVew.category2Name}}</span>
        <span v-show="categoryVew.category3Name">{{categoryVew.category3Name}}</span>
      </div>
      <!-- 主要内容区域 -->
      <div class="mainCon">
        <!-- 左侧放大镜区域 -->
          ...
          <div class="goodsDetail">
            ...
            <div class="support">
              ...
              <div class="supportArea">
                ...
                <div class="fixWidth">河南省 洛阳市 洛龙区</div>
              </div>
            </div>
          </div>
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(saleAttr, index) in spuSaleAttrList" :key="saleAttr.id">
                ...
                <dd changepirce="0"
                    ...
                    v-for="(spuSaleAttrValue,index) in saleAttr.spuSaleAttrValueList"
                    :key="spuSaleAttrValue.id"
                @click="changeactive(spuSaleAttrValue,saleAttr.spuSaleAttrValueList)">
            ...
            <div class="cartWrap">
              <div class="controls">
                ...
                <a href="javascript:" class="mins" @click="goodsnum<=1?goodsnum=1:goodsnum--">-</a>
              </div>
              <div class="add">
...
<script>
  ...
  export default {
    ...
    computed:{
      ...mapGetters({categoryVew:"detail/categoryView",skuInfo:"detail/skuInfo",spuSaleAttrList:"detail/spuSaleAttrList"}),
      skuImageList(){
    ...
    methods:{
     ...
     async addShopCart(){
       ...
       //3:由于addShopCart函数，前面加上了async关键字一定返回的是promise
        try {
          await this.$store.dispatch('detail/addShopCart',{skuId:this.$route.params.skuid,skuNum:this.goodsnum});
          //进行路由跳转
          //将skuinfo和goodsnum传递给下一个组件
